...
// blocking, this function waits until a worker has accepted the job. Otherwise
// this function returns whether a worker was available to accept the job.
...
// of the pool is undefined behavior.
func (p *Pool) Close() {
	close(p.jobs)
	p.wg.Wait()
}
